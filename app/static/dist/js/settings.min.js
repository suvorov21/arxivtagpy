...
$("#tag-fields").prop("disabled",false);});function makeTagEdited(){$(".btn-save").removeClass("disabled");tagEdited=true;var doms=document.getElementsByClassName("tag-label");for(let i=0;i<doms.length;i++){doms[i].style.cursor="not-allowed";}}
