...
if(status===201){raiseAlert("Paper has been added","success");}}).fail(function(){raiseAlert("Paper is not saved due to server error","danger");});};let btnGroup4=document.createElement("div");btnGroup4.setAttribute("class","btn-group mr-2");btnGroup4.setAttribute("role","group");btnPanel.appendChild(btnGroup4);btnGroup4.appendChild(btnBook);let abs=document.createElement("div");abs.setAttribute("class","collapse paper-abs");abs.setAttribute("id","abs-"+pId);abs.textContent=content.abstract;paper.appendChild(abs);}
